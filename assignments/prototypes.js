...
Humanoid.prototype.greet = function(){
  ...
  function Villain(evilAttrs){
    GameObject.call(this, evilAttrs);
    this.name = evilAttrs.name;
    this.power = evilAttrs.power;
  }

  function Hero(goodAttrs){
    GameObject.call(this, goodAttrs);
    Villain.call(this, goodAttrs);
  }
